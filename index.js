...
const sequelize = new Sequelize('postgres://user12345678:pass12345678@database-1.ceoaj7zkmjj1.us-west-2.rds.amazonaws.com:5432/DBNAMEPOSTGRES')
...
app.get('/', (req, res) => res.json({ message: 'Hello World denzel updated4444444' }))
